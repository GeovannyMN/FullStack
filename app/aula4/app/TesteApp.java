...
public class TesteApp {
	...
	public void testeCrudDisciplina(DisciplinaCtrl ctrl) {
		...
		Disciplina disc2 = new Disciplina(null, "LPP", 60);
	...
	public void testeCrudPessoa(PessoaCtrl ctrl) {
		...
		System.out.println("--------------------------------------------------");
		/* Alterado a pessoa */
		pes1.setCpf(15970000000l);
	
		pes1.setNmPessoa("Gerúndyanus S." + pes1.getNmPessoa());
		ctrl.alterar(pes1);

		System.out.println("--------------------------------------------------");
		/* Excluíndo pessoa */
		ctrl.excluir(pes2.getIdPessoa());
		System.out.println("Pessoas Cadastradas");
		for (Pessoa dis : ctrl.buscaTodos()) {
			System.out.println(dis);
		}
	...
	public void testeCrudAluno(AlunoCtrl ctrl, PessoaCtrl pessoaCtrl, CursoCtrl cursoctrl) {
		...
		Aluno aluno1 = new Aluno(62, null, true, pessoaCtrl.buscaPorId(12), cursoctrl.buscaPorId(9));
		Aluno aluno2 = new Aluno(52, null, true, pessoaCtrl.buscaPorId(16), cursoctrl.buscaPorId(7));
